...
Set($RTAddressRegexp , '^inspire\@inspire-?h?e?p?.(net|org)$');
...
Set($CorrespondAddress , 'inspire@inspire-hep.net');
Set($CommentAddress , 'inspire+comments@inspire-hep.net');
...
Set($LogDir, '/var/rt/var/log');  # tcb moved 4/15 due to full filesystem
...
Set($LogoURL , "/images/" . "inspire_logo.png");

  ...
  <xsl:template match='/' >
      <xsl:for-each select="//record">
        <xsl:choose>
            ...
            <xsl:when test="datafield[@tag='980' and @ind1=' ' and @ind2=' ']/subfield[@code='a'] = 'Published'" >
    ...
    <article>
      <front>
        ...
        <article-meta>
          ...
          <xsl:if test="datafield[@tag='035' and @ind1=' ' and @ind2=' ']/subfield[@code='9'] = 'arXiv'">
              <article-id pub-id-type="arXiv">
                <xsl:value-of select="datafield[@tag='035' and @ind1=' ' and @ind2=' ']/subfield[@code='a']" />
              </article-id>
          </xsl:if>
          <contrib-group>
